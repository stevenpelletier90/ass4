 ...
 <html>  
  ...
  <link rel="stylesheet" href="http://sulley.cah.ucf.edu/~ti153451/DIG4503/assignment3/css/materialize.css">
	  <link href="http://sulley.cah.ucf.edu/~ti153451/DIG4503/group_project/Resources%20Page/css/main.css" rel="stylesheet">
	</head>
	<style>
		body {
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.98.2/js/materialize.min.js"></script>
	...
	<div class = "col s12 m5" id = "block">
       ...
       <?php  
			...
			<div class="col s4">  		
				<div class = "card">
                     <form method="post" id = "resources" action="index.php?action=add&id=<?php echo $row["ID"]; ?>">  
 ...
 <!--<div class = "container" style = "width: 1200px" align= "center">
   ...
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <script src="http://sulley.cah.ucf.edu/~ti153451/DIG4503/group_project/Resources%20Page/js/main.js"></script>
    <script src="http://sulley.cah.ucf.edu/~st488021/ass4/js/function.js"></script>
