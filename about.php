...
<body>
    ...
    <div class="row center">
			<h1 id="about-header" class="animated slideInLeft">Our Story</h1>
      <svg xmlns="http://www.w3.org/2000/svg" width="200" height="100" viewBox="0 0 1000 600" version="1.1">
    <g transform="translate(0,-52.362161)">
        ...
        <g transform="matrix(0.98756762,-0.1571948,0.1571948,0.98756762,-1182.3183,622.45437)">
            ...
            <p class="flow-text">Learning new things can be hard a lot of of the time, and we felt that learning should be made easy and convenient. Banding our brains together, we came up with Knight Tutors as a way to solve this problem. </p>
        </div>
        ...
        <div class="main clearfix">
                <div class="bb-custom-wrapper">
                    ...
                    <div class="bb-item">
                    <h1 class="animated slideInRight">About Knight The Tutors</h1>
                    <img src="img/knight-logo.png" width="300" height="300" />
                        </div>
                        <div class="bb-item">
                                    <div class="bb-custom-side">
                            <img  src="img/tiffany.png" width="600" height="600">
                        </div>
                        <div class="bb-custom-side">
                         <h4 class="feature-header">Tiffany Brown  <p class="flow-text bookpad">Currently attending, and soon leaving, UCF as a digital media major. I love to dance, eat, and love traveling to different places</p><h4>
                            ...
                            <div class="bb-item">
                                    <div class="bb-custom-side">
                            <img  src="img/sean.jpg" width="600" height="600">
                        </div>
                        <div class="bb-custom-side">
                         <h4 class="feature-header">Sean Grossman  <p class="flow-text bookpad">When not expanding my digital media knowledge, I am commonly learning about the field of animation.</p><h4>
                                    ...
                                    <div class="bb-item">
                                    <div class="bb-custom-side">
                            <img  src="img/steve.jpg" width="600" height="600">
                        </div>
                        <div class="bb-custom-side">
                         <h4 class="feature-header">Steven Pelletier <p class="flow-text bookpad">Digital Media Web Design major. I like to surf, play video games, travel the country, and play guitar.</p><h4>
                                    ...
                                    <div class="bb-item">
                                    <div class="bb-custom-side">
                            <img  src="img/rita.png" width="600" height="600">
                        </div>
                        <div class="bb-custom-side">
                         <h4 class="feature-header">Rita Ramirez <p class="flow-text bookpad">I am currently attending at the University of Central Florida. I love photography and cooking. I will be graduating in December 2017 with a B.A. in Web Design.</p><h4>
                                    ...
                                    <div class="bb-item">
                                    <div class="bb-custom-side">
                            <img  src="img/leo.jpg" width="600" height="600">
                        </div>
                        <div class="bb-custom-side">
                         <h4 class="feature-header">Leonel Vargas <p class="flow-text bookpad">Majoring in digital media and minoring in music at the University of Central Florida. I'm a percussionist, skating rink DJ, model, voiceover artist, and martial arts instructor.</p><h4>
